...
const aliases: Record<keyof StudentScore, string[]> = {
  ...
  className: ['class_name', 'class', 'lop', 'lop_hoc', 'ten_lop', 'ten lop'],
  teacherName: ['teacher_name', 'teacher', 'giao_vien', 'ten_giao_vien', 'giao vien', 'ten giao vien', 'gv', 'ten_gv'],
  subject: ['subject', 'subject_name', 'mon_hoc', 'mon', 'mon hoc', 'monhoc', 'ten_mon', 'ten_mon_hoc', 'ten mon', 'ten mon hoc'],
